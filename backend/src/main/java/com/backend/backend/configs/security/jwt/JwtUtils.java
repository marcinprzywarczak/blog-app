package com.backend.backend.configs.security.jwt;
...
public class JwtUtils {
    ...
    public ResponseCookie generateJwtCookie(UserDetailsImpl userPrincipal) {
        ...
        // prod ResponseCookie cookie = ResponseCookie.from(jwtCookie, jwt).path("/api").maxAge(24 * 60 * 60).httpOnly(true).sameSite("none").secure(true).build();
